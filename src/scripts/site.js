// site.js
// -----------------------------------------------------------------------
// Unique fichier JS "interactif" du site (hors dashboard, qui a son
// propre script isolé dans DataDashboard.astro). Chargé une fois via
// Layout.astro, donc actif sur toutes les pages.
//
// Il gère, dans l'ordre où les fonctions sont appelées tout en bas
// (voir initializeSite()) :
//   - le menu mobile (ouverture/fermeture, piège de focus clavier)
//   - la navigation active (surligner le bon lien selon la section visible)
//   - la barre de progression de scroll en haut de l'écran
//   - le bouton "retour en haut"
//   - les animations d'apparition au scroll (.reveal)
//   - les onglets de la section Technologies
//   - les compteurs animés de la section Chiffres
// -----------------------------------------------------------------------

"use strict";

// Dès que ce script s'exécute, on sait que le JS est actif : on retire
// la classe "no-js" posée par défaut dans Layout.astro. Ça permet au CSS
// de distinguer "JS désactivé" (repli sur un affichage statique, sans
// animations) de "JS actif" (voir la règle .no-js .reveal dans legacy.css).
